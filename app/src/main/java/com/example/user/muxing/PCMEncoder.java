...
public class PCMEncoder {
    ...
    private static final String TAG = "HAN_PCMEncoder";
    ...
    public void encode(InputStream inputStream, int sampleRate) throws IOException {
        Log.e(TAG, "Starting encoding of InputStream");
        ...
        inputStream.close();
        Log.e(TAG, "Finished encoding of InputStream");
    }

    public void encode(FileInputStream inputStream, int sampleRate) throws IOException {
        Log.e(TAG, "Starting encoding of InputStream");
        byte[] tempBuffer = new byte[2 * sampleRate];
        boolean hasMoreData = true;
        boolean stop = false;
